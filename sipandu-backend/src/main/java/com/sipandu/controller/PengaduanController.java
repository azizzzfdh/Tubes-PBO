...
public class PengaduanController {
    ...
    @GetMapping("/masyarakat/{idMasyarakat}")
    public ApiResponse<List<PengaduanResponse>> getByMasyarakat(@PathVariable Long idMasyarakat) {
        return ApiResponse.ok("Data pengaduan masyarakat berhasil diambil", pengaduanService.getPengaduanByMasyarakat(idMasyarakat));
    }
