...
(4, '2026-05-02 12:35:58.000000', '2026-05-02 12:35:58.000000', 'Layanan pembuatan KTP baru, perubahan data, serta penggantian KTP hilang atau rusak', 'Pembuatan KTP');
...
ALTER TABLE `notifikasi_admin`
  ...
  ADD KEY `FK_notifikasi_admin_pengaduan` (`id_pengaduan`);
...
--
ALTER TABLE `notifikasi_admin`
  ADD CONSTRAINT `FK_notifikasi_admin_pengaduan` FOREIGN KEY (`id_pengaduan`) REFERENCES `pengaduan` (`id_pengaduan`) ON DELETE SET NULL;
